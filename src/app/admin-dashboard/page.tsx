      ...
      <div className="container-fluid px-4 py-3">
        ...
        {metrics && (
          <div className="row g-3 mb-4">
            ...
            <div className="col-md-4 col-sm-6"><Card icon={<Gauge size={20} />} label="Employees Course Completion Percentage" value={`${metrics.employeeCompletionPercentage}%`} color="#FFF5EA" /></div>
          </div>
        )}
